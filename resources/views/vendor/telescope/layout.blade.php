...
<script>
    ...
    //window.Telescope.path = window.location.pathname.substr(1, window.location.pathname.indexOf("telescope") + 9);
    window.Telescope.path = window.location.pathname.substr(1, window.location.pathname.indexOf("telescope") + 8);
</script>
