...
use Vtlabs\Core\Http\Requests\LoginRequest;
use Vtlabs\Core\Http\Requests\CheckUserRequest;
    ...
    public function login(LoginRequest $request)
    {
        try {
            ...
            if ($decoded->iss !== $firebase_ISS) {
                throw new \Exception(strval($decoded->iss) . ' is not a valid issuer' . strval($firebase_ISS));
            }
